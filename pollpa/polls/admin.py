...
def welcome_poll(modeladmin, request, queryset):
    ...
    for poll in queryset:
        ...
        send_many_emails("Personal Time", "introduction", to_grade_tuple, {"poll": poll})

welcome_poll.short_description = "Welcome non-registered emails using selected poll (personal time only)"
